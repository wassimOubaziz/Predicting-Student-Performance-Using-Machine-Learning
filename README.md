...
1. Clone the repository: `git clone https://github.com/wassimOubaziz/Predicting-Student-Performance-Using-Machine-Learning.git`
...
Wassim Oubaziz Prasad, You can also visit my GitHub profile: @wassimOubaziz
